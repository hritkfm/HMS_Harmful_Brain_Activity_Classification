...
import pandas as pd
import torch
from augmentations.augmentation import hms_1D_augmentations
from modules import HMS1DModule
from mydatasets import HMS1DDataModule
...
def main():
    ...
    datamodule = HMS1DDataModule
    transforms = hms_1D_augmentations(augment_args=cfg.transforms)
    dataset_args = {
        "train": {
            "mode": "train",
            "transforms": transforms["audio_train"],
            # "transforms": None,
            **cfg.dataset,
        },
        "val": {
            "mode": "val",
            "transforms": transforms["audio_val"],
            # "transforms": None,
            **cfg.dataset,
        },
    }
