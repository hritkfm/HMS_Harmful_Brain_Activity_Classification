...
from modules import HMSHBACSpecModule
from mydatasets import HMSHBACSpecDataModule
...
def parser():
    ...
    parser.add_argument(
        ...
        default="./configs/hms_spec_V2.yml",
...
def main():
    ...
    datamodule = HMSHBACSpecDataModule
